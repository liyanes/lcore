...
public:
    ...
    inline auto operator*() const noexcept requires (!Void<T>) {return *ptr;}
    inline void operator*() const requires Void<T> {
...
public:
    ...
    inline constexpr auto operator<=>(const Ptr<T>& other) const noexcept {
